...
<template>
  <div v-if="windowState && !windowState.isMinimized" ref="windowRef"
    ...
    <!-- Title Bar -->
    <div ref="handleRef" class="h-8 bg-gray-700/50 flex items-center px-3 gap-2 select-none cursor-default"
      @dblclick="maximizeWindow(props.id)">
      <div class="flex gap-2 group">
        <button @click.stop="closeWindow(props.id)"
        ...
        <button @click.stop="minimizeWindow(props.id)"
        ...
        <button @click.stop="maximizeWindow(props.id)"
